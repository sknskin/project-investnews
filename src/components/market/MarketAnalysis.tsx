    ...
    <div className="mb-8">
      {!analysis && !loading && !error && (
        <Button
          ...
          variant="outline"
          className="h-10 gap-2.5 border-blue-500/20 bg-blue-500/5 text-blue-300 hover:bg-blue-500/10 hover:text-blue-200 hover:border-blue-500/30 transition-all"
        >
          ...
          <div className="flex items-center justify-between mb-4 pb-3 border-b border-border/30">
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 rounded-md bg-gradient-to-br from-blue-500/30 to-violet-500/30 flex items-center justify-center">
                <svg className="w-3.5 h-3.5 text-blue-300" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
